...
def test():
	...
	[testPost(post) for post in webgram.getPosts('Pinwan', 1)]
	[testPost(post) for post in webgram.getPosts('Pinwan', 25)]
	[testPost(post) for post in webgram.getPosts('Pinwan', 45)]
	[testPost(post) for post in webgram.getPosts('Pinwan', 65)]
